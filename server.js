...
app.get('*', (req, res) => {
  if (!req.user) {
    ...
    if (req.get('sec-fetch-dest') === 'document') {
      return res.redirect(302, (PLATFORM_ORIGIN + '/app/test-cf3ec4/full') + deepPath);
    }
...
<body style="font-family:system-ui;background:#09090b;color:#e4e4e7;display:flex;align-items:center;justify-content:center;min-height:100vh;margin:0">
  <div style="max-width:24rem;padding:2rem;text-align:center">
    ...
    <a href="${PLATFORM_ORIGIN}/app/test-cf3ec4/full${deepPath}" style="display:inline-block;padding:0.5rem 1rem;background:#7c3aed;color:white;border-radius:0.5rem;text-decoration:none;font-size:0.9rem">Open in Usernode</a>
  </div>
</body>`);
  }
